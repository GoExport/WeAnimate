  ...
  <div>
    <Transition appear name="slide">
      <div class="importer_asset">
        ...
        <div
          v-if="status == 'await_type' && baseType == 'sound'"
          class="asset_btns"
        >
          <button @click="typeSelected('bgmusic')">
            {{ flatTypeName("bgmusic") }}
          </button>
          <button @click="typeSelected('soundeffect')">
            {{ flatTypeName("soundeffect") }}
          </button>
          <button @click="typeSelected('voiceover')">
            {{ flatTypeName("voiceover") }}
          </button>
          <button @click="$emit('cancelClicked')" class="cancel">Cancel</button>
        </div>
        <div
          v-if="status == 'await_type' && baseType == 'image'"
          class="asset_btns"
        >
          <button @click="typeSelected('bg')">{{ flatTypeName("bg") }}</button>
          <button @click="typeSelected('prop')">
            {{ flatTypeName("prop") }}
          </button>
          <button @click="$emit('cancelClicked')" class="cancel">Cancel</button>
        </div>
        <div
          v-if="status == 'await_type' && baseType == 'video'"
          class="asset_btns"
        >
        ...
        <div v-if="status == 'await_ptype'" class="asset_btns">
          <button @click="propTypeSelected('placeable')">
            {{ flatTypeName("placeable") }}
          </button>
          <button @click="propTypeSelected('holdable')">
            {{ flatTypeName("holdable") }}
          </button>
          <button @click="propTypeSelected('wearable')">
            {{ flatTypeName("wearable") }}
          </button>
          <button @click="$emit('cancelClicked')" class="cancel">Cancel</button>
        </div>
